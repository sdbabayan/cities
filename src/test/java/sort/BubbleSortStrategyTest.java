...
class BubbleSortStrategyTest {
    ...
    private BubbleSortStrategy<Integer> bubbleSortStrategy;
    ...
    void shouldSortEmptyList() {
        // When
        ArrayListToSortByStrategy<Integer> result = bubbleSortStrategy.sort(listToSort, integerComparator);
    ...
    void shouldSortWithCustomComparator() {
        ...
        // When
        ArrayListToSortByStrategy<Integer> result = bubbleSortStrategy.sort(listToSort, reverseComparator);
